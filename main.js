...
function getLaunches (){
    ...
    fetch(url).then((response) =>
        response.json().then((data) => {
            console.log(data);
            let affichageFirstTableau = '<table class="table table-bordered"> <tr><th>Flight number</th><th>Mission name</th><th>Upcoming</th><th>Launch Year</th><th>Launch date utc</th>';
